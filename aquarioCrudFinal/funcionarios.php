...
<body>
    ...
    include('navegacao.php')
        ?>
    <div class="container">
        <h2 class="text-center m-3">Lista dos Funcionários</h2>
        <p>
        ...
        <table class="table table-striped text-center border">
            ...
            <tbody>
                <?php
                    ...
                    $stmt = $objFuncionarios->runQuery($sql);
                    $stmt->execute();
                    while ($objFuncionarios = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ?>
                        <tr>
                            <td>
                                <?php echo $objFuncionarios['id']; ?>
                            </td>
                            <td>
                                <?php echo $objFuncionarios['nome']; ?>
                            </td>
                            <td>
                                <?php echo $objFuncionarios['idade']; ?>
                            </td>
                            <td>
                                <?php echo $objFuncionarios['cpf']; ?>
                            </td>
                            <td>
                                <button 
                                    ...
                                    data-id="<?php echo $objFuncionarios['id']; ?>"
                                    data-nome="<?php echo $objFuncionarios['nome']; ?>"
                                    data-idade="<?php echo $objFuncionarios['idade']; ?>"
                                    data-cpf="<?php echo $objFuncionarios['cpf']; ?>"
                                    > Editar 
                                </button> 
                            </td>
                            <td>
                                <button 
                                    ...
                                    data-id="<?php echo $objFuncionarios['id']; ?>"
                                    data-nome="<?php echo $objFuncionarios['nome']; ?>"> Deletar 
                                </button> 
                            </td>
                        </tr>
                <?php
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="./controle/ctr_funcionarios.php" method="post">
